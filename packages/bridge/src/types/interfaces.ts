...
export interface IMcpClient {
	...
	prepareToolArgs(serverName: string, toolName: string, args: Record<string, unknown>, wsVars: Record<string, unknown> | null, tsVars?: Record<string, unknown> | null): Record<string, unknown>;
}

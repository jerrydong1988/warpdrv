...
import { LuSlidersHorizontal, LuListTodo } from 'react-icons/lu';
			...
			>
				...
				>
					...
					<Flex
						...
						py="2.5"
						borderRadius="lg"
						title={i18nextSingleton.t("chat:sidebar.search")}
						cursor="pointer"
						transition="all 0.15s"
						bg={
					...
					{rightPanelComponents && Object.keys(rightPanelComponents).length > 0 && (
						<Flex
							...
							px="3"
							py="2.5"
							title={i18nextSingleton.t("chat:sidebar.applets")}
							borderRadius="lg"
							cursor="pointer"
							transition="all 0.15s"
							bg={
					...
					<Flex
						...
						py="2.5"
						borderRadius="lg"
						title={i18nextSingleton.t("chat:sidebar.guardrails")}
						cursor="pointer"
						transition="all 0.15s"
						bg={
				...
				>
					...
					<Flex
						...
						borderRadius="lg"
						cursor="pointer"
						title={i18nextSingleton.t("chat:sidebar.config")}
						transition="all 0.15s"
						bg={

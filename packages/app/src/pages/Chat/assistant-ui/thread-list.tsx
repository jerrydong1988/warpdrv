...
function ManualThreadListItem({ thread, onRename, onStartDrag, onSelect, onDelete }: {
	...
	const getAnchorRect = useCallback(() => triggerRef.current?.getBoundingClientRect() ?? null, [triggerRef]);
...
function FolderSection({
	...
	const getAnchorRect = useCallback(() => folderMenuRef.current?.getBoundingClientRect() ?? null, [folderMenuRef]);

...
import type { IMessagePartToolCall, IToolCall, TMessageId, IChatMessage } from '@warpcore/bridge';
...
export const PendingToolCallsBox = React.memo(() => {
	...
	const anchorMessageId = useMemo(() => {
		...
		while (cursor) {
			const msg: IChatMessage | undefined = msgs[cursor];
			if (!msg) return null;

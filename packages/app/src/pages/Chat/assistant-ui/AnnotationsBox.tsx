	...
	return (
		...
		>
			<HStack justify="space-between" align="center" mb="2">
				...
				>
					{i18nextSingleton.t("common:ui.annotations")}
					{annotations.length})
				</Text>
				<Box
					as="button"
						...
						<HStack justify="space-between" align="center" gap="2">
							...
							<HStack gap="1" flexShrink={0}>
								<Box
									...
									title={i18nextSingleton.t("common:ui.editComment")}
								>
									<Pencil size={11} />
								</Box>
								<Box
									...
									title={i18nextSingleton.t("common:ui.remove")}
								>
									<X size={12} />
								</Box>
							</HStack>
						...
						{editingId === annotation.id ? (
							<Box mt="1.5">
								<TextareaAutosize
									...
									placeholder={i18nextSingleton.t("common:ui.typeYourComment")}
									minRows={1}
									maxRows={6}
									style={{
										width: "100%",

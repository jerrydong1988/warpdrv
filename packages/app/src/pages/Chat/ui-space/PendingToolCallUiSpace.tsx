...
export const PendingToolCallUiSpace = React.memo(({ children, toolCallId, messageId }: { children: React.ReactNode; toolCallId: string; messageId: string }) => {
    const componentIds = useStore(s => s.uiSpaceComponentsByLocation[EUISpaceLoc.PENDING_TOOL_CALL]);

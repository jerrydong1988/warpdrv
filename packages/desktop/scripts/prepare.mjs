...
// Node >= 18.20 refuses to spawn .cmd files without a shell on Windows, so
// npm is launched through the shell there and directly elsewhere.
...
// --- 1. Frontend ---------------------------------------------------------------
run('npm', ['run', 'build', '-w', '@warpcore/app'], { cwd: REPO_ROOT });

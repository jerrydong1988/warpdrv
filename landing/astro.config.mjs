      ...
      sidebar: [
              {
                ...
                items: [
                  ...
                  { label: 'Downloading & running your first AI model', slug: 'docs/guides/first-model' },
                  { label: 'Improving your chat experience', slug: 'docs/guides/chat-experience' },
                ],
              },
              {
                label: 'How-to guides',
                items: [
                  ...
                  { label: 'Compile llama.cpp for your system', slug: 'docs/guides/compiling' },
